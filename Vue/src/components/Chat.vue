<template>
  ...
  <div class="wrapper wrapper-content">
      ...
      <section class="module">
        <div class="query" style="display: flex; align-items: center; justify-content: space-between;">
          <div class="wrapper100" v-if="micro == false">
        ...
        <main class="wrapper100 ai-window">
          ...
          <div v-if="answers.length == 0 && online == true">
            <h1 class="title mdc-typography--headline" style="font-size: 80px">
              <div class="material-icons up" style="font-size: 100px">arrow_upward</div>
              <br>
              <br>
              ...
              <br>
              <br>
              <p class="mdc-typography--body2" style="font-size: 60px">{{config.locale.strings.welcomeDescription}}</p>
            </h1>
          </div>
